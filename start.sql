...
(2, 'Site name', 'site-name', 'multilingual_textbox', 1, 'yes', 1, 'main', 'yes'),
...
(1, NULL, 'Index', 'index', NULL, NULL, 'block_user_agent,pages,plh_page,fl_languages,menu,site_config', 'flang_redirect,login', 1, 'Index', 'index', 'Index', 'index'),
