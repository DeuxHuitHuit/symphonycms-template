...
<xsl:variable name="svg-icons-default-fill-color" select="'#878787'" />

<xsl:variable name="svg-icons-real-height" select="'60'" />
<xsl:variable name="svg-icons-default-height" select="'32'" />

<xsl:template name="svg-icons-get-width">
	<xsl:param name="height" />
	<xsl:param name="width" />
	
	<xsl:variable name="ratio" select="number($height) div number($svg-icons-real-height)" />
