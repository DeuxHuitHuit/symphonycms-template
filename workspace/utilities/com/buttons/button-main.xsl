...
<!-- COMPONENT: button-main -->
	<xsl:template name="button-main" match="entry | item" mode="button-main">
		...
		<xsl:variable name="attr-button">
			...
			<add class="padding-vertical-thinnest" />
			<add class="padding-horizontal-thin" />
